...
DATABASE_NAME = environ.get('DATABASE_NAME', "sankark")
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1002036849852')).split()]
